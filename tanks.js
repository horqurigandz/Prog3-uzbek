class Tanks{
    ...
    attack(){
        ...
        if( found1 && this.calldown > 8){
            if(matrix.getMatrix()[0].length > found1[1]+1 && found1[1]+1>=0 && matrix.getMatrix().length > found1[0]+1 && found1[0]+1>=0){
                if(matrix.getMatrix()[found1[0]][found1[1]+1] == 2){
                    matrix.changeMatrix(found1[1]+1,found1[0],6);
                }
                if( matrix.getMatrix()[found1[0]+1][found1[1]] == 2){
                    matrix.changeMatrix(found1[1],found1[0]+1,6);
                }
                if( matrix.getMatrix()[found1[0]+1][found1[1]+1] == 2){
                    matrix.changeMatrix(found1[1]+1,found1[0]+1,6);
                }
            }
